...
class Link(db.Model, Serializer):
    ...
    def add_link(url, platform, text, sentiment, fraud_probability = 0):
        _link = Link(url = url, text = text, platform = platform, sentiment = sentiment, fraud_probability = fraud_probability)
